...
\noindent Il seguente codice Matlab implementa la function richiesta. Anche in questo caso, non sono stati scritti test in quanto la function verr\'a utilizzata nell'Esercizio 5, seppure in versione leggermente modificata. \\
