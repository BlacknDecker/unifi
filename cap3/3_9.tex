...
\footnotesize\noindent\fbox{
	\parbox{\textwidth}{
Inserire due esempi diutilizzo della function implementata per il punto 8 e confrontarela soluzione ottenuta con quella fornita dal comando \(A \textbackslash b\).
	}
}\end{center}
