...
%evito di fattorizzare due volte la stessa matrice
A3 = A;
A4 = A;
...
x3_sol = sol_es_3(algoritmo_3_6(A_3), b3);
cond_A_3_2 = cond(A_3, 2);
r3 = A*x3_sol - b3;
r_b = (r3'*r3) / (b3'*b3);
err = ((x3_sol - x3)'*(x3_sol - x3))/(x3_sol'*x3_sol);

% esercizio 4, fattorizzazione LU con pivoting parziale
[A4, p4] = algoritmo_3_7(A4);
x4_sol = sol_es_4(A4, p4, b4);

% function per fattorizzazione LU con pivot
